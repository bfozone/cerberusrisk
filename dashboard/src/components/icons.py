...
ICONS = {
    ...
    "chart-line": {
        "viewBox": "0 0 15 15",
        "path": 'M1.5 14a.5.5 0 0 1-.5-.5v-12a.5.5 0 0 1 1 0V13h12a.5.5 0 0 1 0 1zM3.604 10.896a.5.5 0 0 1 0-.708l2.75-2.75a.5.5 0 0 1 .708 0L9 9.376l3.146-3.147a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0L6.708 8.5l-2.396 2.396a.5.5 0 0 1-.708 0',
        "fill_rule": "evenodd",
    },
}
